...
**Generated** by `Utility\Scripts\Build-LicenseInventory.ps1` from the locked dependency
graph of the shipped publish — `UI\obj\project.assets.json` (PackageReference closure)
plus the build's own `*.deps.json` (runtime packs embedded by the self-contained
...
> Software License Terms, its end-user pass-through obligations, and the Windows AI
> MachineLearning / .NET self-contained distribution surface) has **not** been
> performed. That review remains an open release item.

## Components

| Component | Version | Kind | Declared license | Shipped license/notice files |
|---|---|---|---|---|
| CommunityToolkit.Mvvm | 8.4.0 | package | expression: MIT | `License.md`<br>`ThirdPartyNotices.txt` |
| Microsoft.Extensions.Configuration | 10.0.0 | package | expression: MIT | `THIRD-PARTY-NOTICES.TXT` |
| Microsoft.Extensions.Configuration.Abstractions | 10.0.0 | package | expression: MIT | `THIRD-PARTY-NOTICES.TXT` |
| Microsoft.Extensions.Configuration.Binder | 10.0.0 | package | expression: MIT | `THIRD-PARTY-NOTICES.TXT` |
| Microsoft.Extensions.Configuration.FileExtensions | 2.0.0 | package | url: https://raw.githubusercontent.com/aspnet/Home/2.0.0/LICENSE.txt | — *(none in package)* |
| Microsoft.Extensions.DependencyInjection | 10.0.0 | package | expression: MIT | `THIRD-PARTY-NOTICES.TXT` |
| Microsoft.Extensions.DependencyInjection.Abstractions | 10.0.0 | package | expression: MIT | `THIRD-PARTY-NOTICES.TXT` |
| Microsoft.Extensions.FileProviders.Abstractions | 2.0.0 | package | url: https://raw.githubusercontent.com/aspnet/Home/2.0.0/LICENSE.txt | — *(none in package)* |
...
| Microsoft.WindowsAppSDK.DWrite | 2.1.0 | package | file: license.txt | `license.txt` |
| Microsoft.WindowsAppSDK.Foundation | 2.3.5 | package | file: license.txt | `license.txt` |
| Microsoft.WindowsAppSDK.InteractiveExperiences | 2.1.3 | package | file: license.txt | `license.txt` |
| Microsoft.WindowsAppSDK.ML | 2.1.74 | package | file: license.txt | `license.txt`<br>`ThirdPartyNotices.txt` |
| Microsoft.WindowsAppSDK.Runtime | 2.3.1 | package | file: license.txt | `license.txt`<br>`NOTICE.txt` |
| Microsoft.WindowsAppSDK.Widgets | 2.0.5 | package | file: license.txt | `license.txt` |
| Microsoft.WindowsAppSDK.WinUI | 2.3.0 | package | file: license.txt | `license.txt`<br>`NOTICE.txt` |
| Microsoft.WindowsDesktop.App.Runtime.win-x64 | 10.0.10 | runtime pack | expression: MIT | `LICENSE` |
| NetEscapades.Configuration.Yaml | 3.1.0 | package | expression: MIT | — *(none in package)* |
| System.Numerics.Tensors | 9.0.0 | package | expression: MIT | `LICENSE.TXT`<br>`THIRD-PARTY-NOTICES.TXT` |
| YamlDotNet | 16.3.0 | package | expression: MIT | — *(none in package)* |
...
| `ThirdPartyLicenses/Microsoft.WindowsDesktop.App.Runtime.win-x64.10.0.10/LICENSE` | 1137 | `A89886665765362EB77E0F8E26602C924520041D1711B2EEDC136434FE4D01AB` |
...
These packages carry no LICENSE/NOTICE file of their own inside the package. Their
terms are the declared license expression in the table above (for the Microsoft
first-party graph these resolve to the MIT text or to the platform license already
reproduced under the components that do ship one).
